...
<head>
    ...
    <title> Masuk | CORK - Multipurpose Bootstrap Dashboard Template </title>
    ...
    <style> 
        body{ 
        background-image:url(assets/img/gb.jpg); 
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">MASUK</h1>
                        <p class="">Gunakan akun anda untuk melanjutkan.</p>
                            ...
                            <div class="form" >
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" name="login" class="btn btn-primary" value="">Masuk</button>
                                    </div>
                                </div>
