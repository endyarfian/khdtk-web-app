...
<head>
    ...
    <title>Jenis Tanaman pada UMT - Sistem Informasi Manejemen KHDTK UGM </title>
...
<body class="alt-menu sidebar-noneoverflow">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="page-header">
                                ...
                                <div class="page-title breadcrumb-four">
                                    ...
                                    <br>
                                    <br>
                                <h3>DATA JENIS TANAMAN PADA UNIT MANAJEMEN TERKECIL</h3>  
                            </div>
                        </div>
                        <div class="widget-content widget-content-area br-6">
                            <table id="zero-config" class="table table-striped" style="width:100%">
                                    <div class="col-lg-6 layout-top-spacing">
                                    <button class="btn btn-outline-info mb-2 " data-toggle="modal" data-target="#cupet_tanam" >
                                        Input Data
                                    </button> 
                                    </div>
                                <thead>
                                <tr>
                                    ...
                                    <th>Tanggal Tanam</th>
                                    <th>Jenis Tanaman (Ilmiah)</th>
                                    <th>Jenis Tanaman (Lokal)</th>
                                    <th>jarak Tanam X</th>
                                    <th>Jarak Tanam Y</th>
                                ...
                                <tbody>                            
                                <?php
                                //data tabel cupet tanam
                                $tabelcupet_tanam = mysqli_query($conn, "SELECT * FROM umt_cupet_tnm");
                                while ($datacupet_tanam = mysqli_fetch_array($tabelcupet_tanam)){
                                    $idcupet_tanam = $datacupet_tanam ['id'];
                                    $kodecupet_tanam = $datacupet_tanam ['KodeCupet_Tnm'];
                                    $kodecupet = $datacupet_tanam ['KodeCucuPetak'];
                                    $tanggaltanam = $datacupet_tanam ['TglTnm'];
                                    $namailmiah = $datacupet_tanam ['JenisTnmIlmiah'];
                                    $namalokal = $datacupet_tanam ['JenisTnmLokal'];
                                    $jaraktanamx = $datacupet_tanam ['JarakTnmX'];
                                    $jaraktanamy = $datacupet_tanam ['JarakTnmY'];
                                ?>
                                <tr>
                                    <td><?=$kodecupet_tanam;?></td>
                                    <td><?=$kodecupet;?></td>
                                    <td><?=$tanggaltanam;?></td>
                                    <td><?=$namailmiah?></td>
                                    <td><?=$namalokal?></td>
                                    ...
                                    <td><?=$jaraktanamy?></td>
                                    <td>
                                        <button type = "button" class="btn btn-light-danger mb-2 mr-2 rounded-circle" title="Hapus data" data-toggle = "modal" data-target = "#hapuscupet_tanam<?=$idcupet_tanam;?>">
                                        ...
                                        <!-- Modal delete cupet tanam-->
                                        <div class="modal fade" id="hapuscupet_tanam<?=$idcupet_tanam;?>" tabindex="-1" role="dialog" aria-labelledby="hapuscupet_tanamlabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="hapuscupet_tanamlabel">Hapus Data Tanaman pada Cucu Petak</h5>
                                                    ...
                                                    <form class="form-vertical" method="post">
                                                        <li class="list-group-item">Kode Tanaman Cucu Petak = <?=$kodecupet_tanam;?></li>
                                                        <li class="list-group-item">Kode Cucu Petak = <?=$kodecupet;?></li>
                                                        <li class="list-group-item">Tanggal Tanam = <?=$tanggaltanam;?></li>
                                                        <li class="list-group-item">Jenis Tanaman (Ilmiah) = <?=$namailmiah;?></li>
                                                        <li class="list-group-item">Jenis Tanaman (Lokal) = <?=$namalokal;?></li>
                                                        <li class="list-group-item">Jarak Tanam X = <?=$jaraktanamx;?></li>
                                                        <li class="list-group-item">Jarak Tanam Y = <?=$jaraktanamy;?></li>
                                                        <div class="form-group mb-4">
                                                            <input type="hidden" value = "<?=$idcupet_tanam;?>" name="idcupet_tanam" > 
                                                        </div>
                                                            <div class="modal-footer">
                                                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                            <button type="submit" name="hapuscupet_tanam" class="btn btn-danger">Hapus</button>
                                                            </div>     
                                                    </form>         
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="cupet_tanam" tabindex="-1" role="dialog" aria-labelledby="cupet_tanamlabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="cupet_tanamlabel">Input Data Tanaman pada Cucu Petak</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="form-vertical" method="post">
                    <input type="hidden" name="idcupet_tanam" >
                        <div class="form-group mb-4">
                            <label class="form-label">Kode Tanaman Cucu Petak</label>
                            <input type="text" name="kodecupet_tanam" class="form-control" >
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Masukkan kode tanaman pada cucu petak.</small>
                                </span>
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label">Kode Cucu Petak</label>
                            <select name="kodecupet" class="form-control" >
                                    <?php 
                                    $getkodecupet = mysqli_query($conn, "SELECT * FROM umt_cucupetak");
                                    while($rowkodecupet = mysqli_fetch_array($getkodecupet)){?>
                                    <option><?php echo $rowkodecupet ['Kode Cucu Petak']?></option>
                                    <?php } ?>
                                </select>
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Pilih kode cucu petak.</small>
                                </span>
                            </div> 
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label">Tanggal Tanam</label>
                            <input type="date" name="tanggaltanam" class="form-control" >
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Masukkan tanggal penanaman.</small>
                                </span>
                            </div> 
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label">Janis Tanaman (Nama Ilmiah)</label>
                            <input type="text" name="namailmiah" class="form-control" >
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Masukkan nama ilmiah tanaman.</small>
                                </span>
                            </div>  
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label">Janis Tanaman (Nama Lokal)</label>
                            <input type="text" name="namalokal" class="form-control" >
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Masukkan nama lokal tanaman.</small>
                                </span>
                            </div>  
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label">Jarak Tanam X</label>
                            <input type="text" name="jaraktanamx" class="form-control" >
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Masukkan jarak tanam pada sumbu X.</small>
                                </span>
                            </div>  
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label">Jarak Tanam Y</label>
                            <input type="text" name="jaraktanamy" class="form-control" >
                            <div class=" mt-1">
                                <span class="badge badge-success">
                                    <small id="sh-text4" class="form-text mt-0">Masukkan jarak tanam pada sumbu Y.</small>
                                </span>
                            </div>  
                        </div>
                        <div class="modal-footer">
                        <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                        <button type="submit" name="inputcupet_tanam" class="btn btn-primary snackbar-bg-success">Simpan</button>
                        </div>
                    </form>               
                </div>
            </div>
